                   ...
                   <label for="kodbr">ID Barang</label>
                    <select class="form-control" type="text" name="kodbar" id="kodbr"  >
                      <option value="">--Pilih--</option>
                          ...
                          ?>
                          <option value="<?=$data['id_barang'];?>"><?php echo $data['id_barang'];?></option>
                              <?php
                                  }
                              ?>
                   ...
                   <label for="kodbr">ID Pengirim</label>
                    <select class="form-control" type="text" name="kodpeng" id="kodpng"  >
                      <option value="">--Pilih--</option>
                          <?php
                              include('../database/koneksi.php');
                              $query    =mysqli_query($koneksi, "SELECT * FROM tbl_pengirim GROUP BY id_pengirim ORDER BY id_pengirim");
                              while ($data = mysqli_fetch_array($query)) {
                          ?>
                          <option value="<?=$data['id_pengirim'];?>"><?php echo $data['id_pengirim'];?></option>
                              <?php
                                  }
                              ?>
