...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 20 Agu 2021 pada 18.04
...
INSERT INTO `tbl_kurir` (`id_kurir`, `username`, `email`, `nama`, `alamat`, `nohp`, `password`) VALUES
(4, 'dsad', 'prasety2423@gmail.com', 'dsdasdasdas', 'dsadas', 321312, 0),
(5, '', '', '', '', 0, 0),
(6, 'dsadas', 'dsadas@gmail.com', 'dsadasdsadsa', 'dsadsa', 342423, 0),
(7, 'dsadas', 'dsadas@gmail.com', 'dsadasdsadsa', 'dsadsa', 342423, 0);
...
--
ALTER TABLE `tbl_kurir`
  MODIFY `id_kurir` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
